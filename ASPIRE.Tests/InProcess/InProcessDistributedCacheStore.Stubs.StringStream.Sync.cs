...
{
    // SortedSet
    public bool SortedSetAdd(RedisKey key, RedisValue member, double score, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public bool SortedSetAdd(RedisKey key, RedisValue member, double score, SortedSetWhen when, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public long SortedSetAdd(RedisKey key, SortedSetEntry[] values, SortedSetWhen when, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public RedisValue[] SortedSetRangeByValue(RedisKey key, RedisValue min, RedisValue max, Exclude exclude = Exclude.None, long skip = 0, long take = -1, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public RedisValue[] SortedSetRangeByValue(RedisKey key, RedisValue min, RedisValue max, Exclude exclude, Order order, long skip = 0, long take = -1, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public IEnumerable<SortedSetEntry> SortedSetScan(RedisKey key, RedisValue pattern = default, int pageSize = 250, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public IEnumerable<SortedSetEntry> SortedSetScan(RedisKey key, RedisValue pattern, int pageSize, long cursor, int pageOffset, CommandFlags flags) => throw new NotImplementedException();
    ...
    public bool SortedSetUpdate(RedisKey key, RedisValue member, double score, SortedSetWhen when, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public long SortedSetUpdate(RedisKey key, SortedSetEntry[] values, SortedSetWhen when, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public StreamTrimResult StreamAcknowledgeAndDelete(RedisKey key, RedisValue groupName, StreamTrimMode mode, RedisValue messageId, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public StreamTrimResult[] StreamAcknowledgeAndDelete(RedisKey key, RedisValue groupName, StreamTrimMode mode, RedisValue[] messageIds, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public RedisValue StreamAdd(RedisKey key, RedisValue field, RedisValue value, RedisValue? messageId = null, int? maxLength = null, bool useApproximateMaxLength = false, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public RedisValue StreamAdd(RedisKey key, NameValueEntry[] entries, RedisValue? messageId = null, int? maxLength = null, bool useApproximateMaxLength = false, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public RedisValue StreamAdd(RedisKey key, RedisValue field, RedisValue value, RedisValue? messageId, long? maxLength, bool useApproximateMaxLength, long? minId, StreamTrimMode trimMode, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public RedisValue StreamAdd(RedisKey key, NameValueEntry[] entries, RedisValue? messageId, long? maxLength, bool useApproximateMaxLength, long? minId, StreamTrimMode trimMode, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public StreamAutoClaimResult StreamAutoClaim(RedisKey key, RedisValue groupName, RedisValue consumerName, long minIdleTime, RedisValue startId, int? count = null, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public StreamAutoClaimIdsOnlyResult StreamAutoClaimIdsOnly(RedisKey key, RedisValue groupName, RedisValue consumerName, long minIdleTime, RedisValue startId, int? count = null, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public StreamEntry[] StreamClaim(RedisKey key, RedisValue groupName, RedisValue consumerName, long minIdleTime, RedisValue[] messageIds, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public RedisValue[] StreamClaimIdsOnly(RedisKey key, RedisValue groupName, RedisValue consumerName, long minIdleTime, RedisValue[] messageIds, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public bool StreamConsumerGroupSetPosition(RedisKey key, RedisValue groupName, RedisValue messageId, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public bool StreamCreateConsumerGroup(RedisKey key, RedisValue groupName, RedisValue? messageId = null, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public bool StreamCreateConsumerGroup(RedisKey key, RedisValue groupName, RedisValue? messageId, bool createStream, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public StreamPendingMessageInfo[] StreamPendingMessages(RedisKey key, RedisValue groupName, int count, RedisValue consumerName, RedisValue? minId, RedisValue? maxId, long? minIdleTime, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public StreamEntry[] StreamRange(RedisKey key, RedisValue? minId = null, RedisValue? maxId = null, int? count = null, Order order = Order.Ascending, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public RedisStream[] StreamRead(StreamPosition[] streams, int? count = null, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public StreamEntry[] StreamReadGroup(RedisKey key, RedisValue groupName, RedisValue consumerName, RedisValue? position = null, int? count = null, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public StreamEntry[] StreamReadGroup(RedisKey key, RedisValue groupName, RedisValue consumerName, RedisValue? position, int? count, bool noAck, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public RedisStream[] StreamReadGroup(StreamPosition[] streams, RedisValue groupName, RedisValue consumerName, int? count = null, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public RedisStream[] StreamReadGroup(StreamPosition[] streams, RedisValue groupName, RedisValue consumerName, int? count, bool noAck, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public long StreamTrim(RedisKey key, long maxLength, bool useApproximateMaxLength, long? minId, StreamTrimMode trimMode, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public long StreamTrimByMinId(RedisKey key, RedisValue minId, bool useApproximateMaxLength, long? limit, StreamTrimMode trimMode, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public long StringBitCount(RedisKey key, long start = 0, long end = -1, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public long StringBitCount(RedisKey key, long start, long end, StringIndexType indexType, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public long StringBitOperation(Bitwise operation, RedisKey destination, RedisKey first, RedisKey second, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public long StringBitPosition(RedisKey key, bool bit, long start = 0, long end = -1, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public long StringBitPosition(RedisKey key, bool bit, long start, long end, StringIndexType indexType, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public string? StringLongestCommonSubsequence(RedisKey key1, RedisKey key2, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public long StringLongestCommonSubsequenceLength(RedisKey key1, RedisKey key2, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public LCSMatchResult StringLongestCommonSubsequenceWithMatches(RedisKey key1, RedisKey key2, long minResultLength = 0, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public bool StringSet(RedisKey key, RedisValue value, TimeSpan? expiry = null, When when = When.Always, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public bool StringSet(RedisKey key, RedisValue value, TimeSpan? expiry, bool keepTtl, When when = When.Always, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public RedisValue StringSetAndGet(RedisKey key, RedisValue value, TimeSpan? expiry = null, When when = When.Always, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public RedisValue StringSetAndGet(RedisKey key, RedisValue value, TimeSpan? expiry, bool keepTtl, When when = When.Always, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
...
#pragma warning disable SER001
    ...
    public int VectorSetDimension(RedisKey key, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public Lease<float>? VectorSetGetApproximateVector(RedisKey key, RedisValue member, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public Lease<RedisValue>? VectorSetGetLinks(RedisKey key, RedisValue member, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public Lease<VectorSetLink>? VectorSetGetLinksWithScores(RedisKey key, RedisValue member, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public VectorSetInfo? VectorSetInfo(RedisKey key, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public long VectorSetLength(RedisKey key, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public RedisValue VectorSetRandomMember(RedisKey key, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public bool VectorSetSetAttributesJson(RedisKey key, RedisValue member, string json, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public Lease<VectorSetSimilaritySearchResult>? VectorSetSimilaritySearch(RedisKey key, VectorSetSimilaritySearchRequest request, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
