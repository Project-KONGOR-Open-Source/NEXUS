...
public partial class InProcessDistributedCacheStore
{
    ...
    public GeoRadiusResult[] GeoRadius(RedisKey key, RedisValue member, double radius, GeoUnit unit = GeoUnit.Meters, int count = -1, Order? order = null, GeoRadiusOptions options = GeoRadiusOptions.None, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public GeoRadiusResult[] GeoRadius(RedisKey key, double longitude, double latitude, double radius, GeoUnit unit = GeoUnit.Meters, int count = -1, Order? order = null, GeoRadiusOptions options = GeoRadiusOptions.None, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public GeoRadiusResult[] GeoSearch(RedisKey key, RedisValue member, GeoSearchShape shape, int count = -1, bool demand = false, Order? order = null, GeoRadiusOptions options = GeoRadiusOptions.None, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public GeoRadiusResult[] GeoSearch(RedisKey key, double longitude, double latitude, GeoSearchShape shape, int count = -1, bool demand = false, Order? order = null, GeoRadiusOptions options = GeoRadiusOptions.None, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public long GeoSearchAndStore(RedisKey destination, RedisKey key, RedisValue member, GeoSearchShape shape, int count = -1, bool demand = false, Order? order = null, bool storeDist = false, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public long GeoSearchAndStore(RedisKey destination, RedisKey key, double longitude, double latitude, GeoSearchShape shape, int count = -1, bool demand = false, Order? order = null, bool storeDist = false, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public RedisValue HashFieldGetAndSetExpiry(RedisKey key, RedisValue hashField, TimeSpan? expiry, bool keepTtl = false, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public RedisValue[] HashFieldGetAndSetExpiry(RedisKey key, RedisValue[] hashFields, TimeSpan? expiry, bool keepTtl = false, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public Lease<byte>? HashFieldGetLeaseAndDelete(RedisKey key, RedisValue hashField, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public Lease<byte>? HashFieldGetLeaseAndSetExpiry(RedisKey key, RedisValue hashField, TimeSpan? expiry, bool keepTtl = false, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public Lease<byte>? HashFieldGetLeaseAndSetExpiry(RedisKey key, RedisValue hashField, DateTime expiry, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public RedisValue HashFieldSetAndSetExpiry(RedisKey key, RedisValue hashField, RedisValue value, TimeSpan? expiry, bool keepTtl = false, When when = When.Always, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public RedisValue HashFieldSetAndSetExpiry(RedisKey key, HashEntry[] hashFields, TimeSpan? expiry, bool keepTtl = false, When when = When.Always, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public IEnumerable<HashEntry> HashScan(RedisKey key, RedisValue pattern = default, int pageSize = 250, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public IEnumerable<HashEntry> HashScan(RedisKey key, RedisValue pattern, int pageSize, long cursor, int pageOffset, CommandFlags flags) => throw new NotImplementedException();
    public IEnumerable<RedisValue> HashScanNoValues(RedisKey key, RedisValue pattern, int pageSize, long cursor, int pageOffset, CommandFlags flags) => throw new NotImplementedException();
    ...
    public void HyperLogLogMerge(RedisKey destination, RedisKey source1, RedisKey source2, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
