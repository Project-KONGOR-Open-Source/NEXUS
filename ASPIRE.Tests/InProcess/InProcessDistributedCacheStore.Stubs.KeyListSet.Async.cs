...
{
    // Key Async
    public Task<EndPoint?> IdentifyEndpointAsync(RedisKey key, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public Task<bool> KeyExpireAsync(RedisKey key, DateTime? expiry, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public Task<bool> KeyExpireAsync(RedisKey key, DateTime? expiry, ExpireWhen when, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public Task KeyMigrateAsync(RedisKey key, EndPoint toEndpoint, int toDatabase = 0, int timeoutMilliseconds = 0, MigrateOptions options = MigrateOptions.None, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public Task<long> ListLeftPushAsync(RedisKey key, RedisValue[] values, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public Task<long> ListLengthAsync(RedisKey key, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public Task<RedisValue> ListMoveAsync(RedisKey source, RedisKey destination, ListSide sourceSide, ListSide destinationSide, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public Task<long> ListPositionAsync(RedisKey key, RedisValue value, long rank = 1, long maxLength = 0, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    public Task<long[]> ListPositionsAsync(RedisKey key, RedisValue value, long rank = 1, long count = 1, long maxLength = 0, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public Task<long> ListRightPushAsync(RedisKey key, RedisValue[] values, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public Task<RedisResult> ScriptEvaluateAsync(byte[] script, RedisKey[]? keys = null, RedisValue[]? values = null, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
    ...
    public Task<RedisResult> ScriptEvaluateReadOnlyAsync(byte[] script, RedisKey[]? keys = null, RedisValue[]? values = null, CommandFlags flags = CommandFlags.None) => throw new NotImplementedException();
