        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SanitizedEmailAddress = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000001"), "be7b4e6d-29d8-4c3b-bffb-6635418cd47d", "Administrator", "ADMINISTRATOR" },
                    { new Guid("00000000-0000-0000-0000-000000000002"), "0b54499d-d84f-4196-9c99-e99e87f03792", "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_Name_SanitizedEmailAddress",
                table: "Users",
                columns: new[] { "Name", "SanitizedEmailAddress" },
                unique: true);
