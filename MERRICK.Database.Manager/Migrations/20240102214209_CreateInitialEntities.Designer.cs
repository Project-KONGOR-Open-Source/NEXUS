...
namespace MERRICK.Database.Manager.Migrations
{
    ...
    [Migration("20240102214209_CreateInitialEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MERRICK.Database.Models.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("00000000-0000-0000-0000-000065f3ae91"),
                            Name = "Administrator"
                        },
                        new
                        {
                            ID = new Guid("00000000-0000-0000-0000-000036dd4275"),
                            Name = "User"
                        });
                });
            ...
            modelBuilder.Entity("MERRICK.Database.Models.Entities.User", b =>
                {
                    b.HasOne("MERRICK.Database.Models.Entities.Role", "Role")
                        .WithMany()
