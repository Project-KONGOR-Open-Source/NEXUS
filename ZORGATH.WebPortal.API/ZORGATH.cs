...
public class ZORGATH
{
    public static void Main(string[] arguments)
    {
        ...
        // Username And Password Validation Policies Are Enforced By FluentValidation Validators (AccountNameValidator And PasswordValidator) In The Controller Actions
        // Account name validation runs in all environments; password strength validation is skipped in development for testing convenience
