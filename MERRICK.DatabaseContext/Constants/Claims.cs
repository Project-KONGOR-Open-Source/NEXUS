...
/// <summary>
///     <para>
///         Used for setting and getting claims for JwtSecurityToken.Claims or for User.Claims (inside a controller
///         action).
///         Compared to JwtSecurityToken.Claims, some of these claims will be different when getting them from User.Claims.
///     </para>
///     <para>
///         "email" in JwtSecurityToken.Claims is "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress" in
///         User.Claims.
///         <br />
///         "sub" in JwtSecurityToken.Claims is "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/nameidentifier" in
///         User.Claims.
///     </para>
/// </summary>
