...
namespace MERRICK.DatabaseContext.Migrations
{
    ...
    [Migration("20251222215228_ExtractDiscordProfile")]
    partial class ExtractDiscordProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MERRICK.DatabaseContext.Entities.Core.UserDiscordProfile", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MERRICK.DatabaseContext.Entities.Core.UserDiscordProfile", b =>
                {
                    b.HasOne("MERRICK.DatabaseContext.Entities.Core.User", "User")
                        .WithOne("DiscordProfile")
                        .HasForeignKey("MERRICK.DatabaseContext.Entities.Core.UserDiscordProfile", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
