    ...
    public partial class CreateInitialEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "KONGOR", "K", new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4831) },
                    { 2, "Project KONGOR Developers", ".NET", new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4837) },
                    { 3, "Project KONGOR", "PK", new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4839) },
                    { 4, "Project KONGOR Open-Source", "PKOS", new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4841) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 666, "[\"KONGOR\",\"TERMINAL\"]", 2, 3, "[]", true, "[]", "KONGOR", "[\"ai.custom_icon:1\",\"av.Flamboyant\",\"c.cat_courier\",\"cc.frostburnlogo\",\"cr.Punk Creep\",\"cs.frostburnlogo\",\"m.Super-Taunt\",\"sc.paragon_circle_upgrade\",\"t.Dumpster_Taunt\",\"te.Punk TP\",\"w.8bit_ward\"]", "[]", "[]", new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4875), new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4870), new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4875), 5, 1 },
                    { 2, 666, "[\"KONGOR\",\"TERMINAL\"]", 1, 3, "[]", false, "[]", "ONGOR", "[\"ai.custom_icon:1\",\"av.Flamboyant\",\"c.cat_courier\",\"cc.frostburnlogo\",\"cr.Punk Creep\",\"cs.frostburnlogo\",\"m.Super-Taunt\",\"sc.paragon_circle_upgrade\",\"t.Dumpster_Taunt\",\"te.Punk TP\",\"w.8bit_ward\"]", "[]", "[]", new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4882), new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4879), new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4882), 5, 1 },
                    { 3, 666, "[\"KONGOR\",\"TERMINAL\"]", 1, 2, "[]", false, "[]", "GOPO", "[\"ai.custom_icon:1\",\"av.Flamboyant\",\"c.cat_courier\",\"cc.frostburnlogo\",\"cr.Punk Creep\",\"cs.frostburnlogo\",\"m.Super-Taunt\",\"sc.paragon_circle_upgrade\",\"t.Dumpster_Taunt\",\"te.Punk TP\",\"w.8bit_ward\"]", "[]", "[]", new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4886), new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4883), new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4886), 5, 1 },
                    { 4, 666, "[\"KONGOR\",\"TERMINAL\"]", 1, 2, "[]", false, "[]", "Xen0byte", "[\"ai.custom_icon:1\",\"av.Flamboyant\",\"c.cat_courier\",\"cc.frostburnlogo\",\"cr.Punk Creep\",\"cs.frostburnlogo\",\"m.Super-Taunt\",\"sc.paragon_circle_upgrade\",\"t.Dumpster_Taunt\",\"te.Punk TP\",\"w.8bit_ward\"]", "[]", "[]", new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4889), new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4887), new DateTime(2024, 4, 3, 19, 15, 19, 318, DateTimeKind.Utc).AddTicks(4889), 5, 1 }
                });
