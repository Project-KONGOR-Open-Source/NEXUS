    ...
    public partial class CreateInitialEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "KONGOR", "K", new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6500) },
                    { 2, "Project KONGOR Developers", ".NET", new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6505) },
                    { 3, "Project KONGOR", "PK", new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6507) },
                    { 4, "Project KONGOR Open-Source", "PKOS", new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6509) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 666, "[\"KONGOR\",\"TERMINAL\"]", 2, 3, "[]", true, "[]", "KONGOR", "[\"ai.custom_icon:1\",\"av.Flamboyant\",\"c.cat_courier\",\"cc.frostburnlogo\",\"cr.Punk Creep\",\"cs.frostburnlogo\",\"m.Super-Taunt\",\"sc.paragon_circle_upgrade\",\"t.Dumpster_Taunt\",\"te.Punk TP\",\"w.8bit_ward\"]", "[]", "[]", new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6546), new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6542), new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6546), 5, 1 },
                    { 2, 666, "[\"KONGOR\",\"TERMINAL\"]", 1, 3, "[]", false, "[]", "ONGOR", "[\"ai.custom_icon:1\",\"av.Flamboyant\",\"c.cat_courier\",\"cc.frostburnlogo\",\"cr.Punk Creep\",\"cs.frostburnlogo\",\"m.Super-Taunt\",\"sc.paragon_circle_upgrade\",\"t.Dumpster_Taunt\",\"te.Punk TP\",\"w.8bit_ward\"]", "[]", "[]", new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6558), new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6555), new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6558), 5, 1 },
                    { 3, 666, "[\"KONGOR\",\"TERMINAL\"]", 1, 2, "[]", false, "[]", "GOPO", "[\"ai.custom_icon:1\",\"av.Flamboyant\",\"c.cat_courier\",\"cc.frostburnlogo\",\"cr.Punk Creep\",\"cs.frostburnlogo\",\"m.Super-Taunt\",\"sc.paragon_circle_upgrade\",\"t.Dumpster_Taunt\",\"te.Punk TP\",\"w.8bit_ward\"]", "[]", "[]", new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6561), new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6559), new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6561), 5, 1 },
                    { 4, 666, "[\"KONGOR\",\"TERMINAL\"]", 1, 2, "[]", false, "[]", "Xen0byte", "[\"ai.custom_icon:1\",\"av.Flamboyant\",\"c.cat_courier\",\"cc.frostburnlogo\",\"cr.Punk Creep\",\"cs.frostburnlogo\",\"m.Super-Taunt\",\"sc.paragon_circle_upgrade\",\"t.Dumpster_Taunt\",\"te.Punk TP\",\"w.8bit_ward\"]", "[]", "[]", new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6564), new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6562), new DateTime(2024, 4, 3, 18, 32, 55, 429, DateTimeKind.Utc).AddTicks(6564), 5, 1 }
                });
