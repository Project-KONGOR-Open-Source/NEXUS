...
public static class ChatProtocol
{
    ...
    {
     // public const byte MM_COMMAND_GROUP_INIT                             = 0x0002;   // It Is Not Clear If This Is Actually "MM_COMMAND_GROUP_INIT" Or What "(0x02)" Actually Does
        ...
        public const ushort CHAT_CMD_CLAN_PROMOTE_NOTIFY                    = 0x0015;   // Sent With Notification Keys For The Server To Verify On Clan Promotion
        public const ushort CHAT_CMD_CLAN_DEMOTE_NOTIFY                     = 0x0016;   // Sent With Notification Keys For The Server To Verify On Clan Demotion
        public const ushort CHAT_CMD_CLAN_REMOVE_NOTIFY                     = 0x0017;   // Sent With Notification Keys For The Server To Verify On Clan Removal
        public const ushort EMPTY_0x18                                      = 0x0018;
        public const ushort EMPTY_0x19                                      = 0x0019;
        public const ushort EMPTY_0x1A                                      = 0x001A;
        public const ushort CHAT_CMD_FLOODING                               = 0x001B;   // Warning To User That Their Message Wasn't Sent Due To Flood Control
        ...
        public const ushort CHAT_CMD_INVITE_USER_ID                         = 0x0023;   // Sent By Game Server To Invite A User To A Game By Account ID
        public const ushort CHAT_CMD_INVITE_USER_NAME                       = 0x0024;   // Sent By Game Server To Invite A User To A Game By Account Name
        public const ushort CHAT_CMD_INVITED_TO_SERVER                      = 0x0025;   // Sent By Chat Server To Notify A User Of A Pending Server Invite
        public const ushort CHAT_CMD_INVITE_FAILED_USER                     = 0x0026;   // Notifies A User That Their Invite Request Failed Because The Target Was Not Found
        public const ushort CHAT_CMD_INVITE_FAILED_GAME                     = 0x0027;   // Notifies A User That Their Invite Request Failed Because They Are Not In A Game
        ...
        public const ushort CHAT_CMD_CHANNEL_ADD_AUTH_USER                  = 0x0040;   // User Wants To Add A User To The Authorization List For A Channel
        public const ushort CHAT_CMD_CHANNEL_REMOVE_AUTH_USER               = 0x0041;   // User Wants To Remove A User From The Authorization List For A Channel
        public const ushort CHAT_CMD_CHANNEL_LIST_AUTH                      = 0x0042;   // User Wants To Get The Authorization List For A Channel
        public const ushort CHAT_CMD_CHANNEL_SET_PASSWORD                   = 0x0043;   // User Wants To Set The Password For A Channel
        public const ushort CHAT_CMD_CHANNEL_ADD_AUTH_FAIL                  = 0x0044;   // Failed To Add The User To The Channel Authorization List
        public const ushort CHAT_CMD_CHANNEL_REMOVE_AUTH_FAIL               = 0x0045;   // Failed To Remove The User From The Channel Authorization List
        ...
        public const ushort CHAT_CMD_CLAN_ADD_FAIL_ONLINE                   = 0x0049;   // Request To Add A Member Failed, User Was Not Online
        public const ushort CHAT_CMD_CLAN_ADD_FAIL_CLAN                     = 0x004A;   // Request To Add A Member Failed, User Is In A Clan
        public const ushort CHAT_CMD_CLAN_ADD_FAIL_INVITED                  = 0x004B;   // Request To Add A Member Failed, User Has Already Been Invited
        public const ushort CHAT_CMD_CLAN_ADD_FAIL_PERMS                    = 0x004C;   // Request To Add A Member Failed, User Does Not Have Proper Permissions
        ...
        public const ushort CHAT_CMD_CLAN_CREATE_FAIL_CLAN                  = 0x0055;   // Clan Creation Failed, One Or More Users Are Already In A Clan
        public const ushort CHAT_CMD_CLAN_CREATE_FAIL_INVITE                = 0x0056;   // Clan Creation Failed, One Or More Users Have An Outstanding Clan Invitation
        public const ushort CHAT_CMD_CLAN_CREATE_FAIL_FIND                  = 0x0057;   // Clan Creation Failed, One Or More Users Could Not Be Found
        public const ushort CHAT_CMD_CLAN_CREATE_FAIL_DUPE                  = 0x0058;   // Clan Creation Failed, Duplicate Founding Members
        public const ushort CHAT_CMD_CLAN_CREATE_FAIL_PARAM                 = 0x0059;   // Clan Creation Failed, One Or More Parameters Are Invalid
