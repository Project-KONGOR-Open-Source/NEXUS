...
public class GroupCreate(IMatchmakingService matchmakingService, MerrickContext merrick) : ISynchronousCommandProcessor<ChatSession>
{
    public void Process(ChatSession session, ChatBuffer buffer)
    {
        ...
        MatchmakingGroup
            .Create(matchmakingService, session, merrick, requestData.ToGroupInformation());
    }
}