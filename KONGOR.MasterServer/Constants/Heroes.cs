...
public static class Heroes
{
    ...
    public static class PlagueRider
    {
        ...
        public const uint HeroId = 120;
        public const string Identifier = "Hero_DiseasedRider"; // Correct internal ID per assets
    ...
    public static class Jeraziah
    {
        ...
        public const uint HeroId = 12; // Base ID verified
    ...
    public static class Pandamonium
    {
        ...
        public const uint HeroId = 122; // Confirmed missing
