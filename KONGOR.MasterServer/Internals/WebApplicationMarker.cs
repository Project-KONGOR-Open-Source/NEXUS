namespace KONGOR.MasterServer.Internals;

/// <summary>
///     Used in the unit/integration tests project as a marker for the KONGOR.MasterServer assembly.
...
/// </summary>
public interface KONGORAssemblyMarker
{
}