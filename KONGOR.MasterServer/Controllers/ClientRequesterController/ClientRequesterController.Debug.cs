...
using global::KONGOR.MasterServer.Models.RequestResponse.SRP;
using System.Text;
...
public partial class ClientRequesterController
{
    private async Task<IActionResult> HandleDebugUpgradesDiff()
    {
        try
        {
            ...
            if (string.IsNullOrEmpty(cookie)) return BadRequest("Missing cookie");
            ...
            if (sessionAccountName is null) return Unauthorized("Session Not Found");
            ...
            foreach (string item in account.User.OwnedStoreItems) myUpgradesInfo[item] = new StoreItemData();
