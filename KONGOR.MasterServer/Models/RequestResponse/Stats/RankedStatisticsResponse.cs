...
/// <summary>
///     Response for show_stats with table="ranked" (ranked matchmaking statistics with rnk_ prefix).
/// </summary>
public class RankedStatisticsResponse(Account account, AccountStatistics statistics, AggregateStatistics aggregates)
{
    ...
    /// <summary>
    ///     Total times kicked from ranked matches.
    /// </summary>
    [PHPProperty("rnk_kicked")]
    public string Kicked { get; init; } = statistics.MatchesKicked.ToString();

    /// <summary>
    ///     Solo queue matchmaking rating (MMR). Base rating is 1500.
    /// </summary>
    [PHPProperty("rnk_amm_solo_rating")]
    public string SoloRating { get; init; } = "1500.000"; // TODO: Implement Solo Queue Rating

    /// <summary>
    ///     Total solo queue matches counted towards rating.
    /// </summary>
    [PHPProperty("rnk_amm_solo_count")]
    public string SoloCount { get; init; } = "0"; // TODO: Implement Solo Queue Rating

    /// <summary>
    ///     Solo queue rating confidence (0.00 to 1.00). Higher values indicate more stable rating.
    /// </summary>
    [PHPProperty("rnk_amm_solo_conf")]
    public string SoloConfidence { get; init; } = "0.00"; // TODO: Implement Solo Queue Rating

    /// <summary>
    ///     Number of provisional (placement) matches played in solo queue.
    /// </summary>
    [PHPProperty("rnk_amm_solo_prov")]
    public string SoloProvisional { get; init; } = "0"; // TODO: Implement Solo Queue Rating

    /// <summary>
    ///     Solo queue placement set identifier. Changes each rating reset.
    /// </summary>
    [PHPProperty("rnk_amm_solo_pset")]
    public string SoloPlacementSet { get; init; } = "0"; // TODO: Implement Solo Queue Rating
    ...
    /// </summary>
    [PHPProperty("rnk_amm_team_count")]
    public string TeamCount { get; init; } = statistics.MatchesPlayed.ToString();

    /// <summary>
    ///     Team queue rating confidence (0.00 to 1.00). Higher values indicate more stable rating.
    /// </summary>
    [PHPProperty("rnk_amm_team_conf")]
    public string TeamConfidence { get; init; } = "0.00"; // TODO: Implement Team Queue Confidence

    /// <summary>
    ///     Number of provisional (placement) matches played in team queue.
    /// </summary>
    [PHPProperty("rnk_amm_team_prov")]
    public string TeamProvisional { get; init; } = statistics.MatchesPlayed.ToString();

    /// <summary>
    ///     Team queue placement set identifier. Changes each rating reset.
    /// </summary>
    [PHPProperty("rnk_amm_team_pset")]
    public string TeamPlacementSet { get; init; } = "127"; // TODO: Implement Placement Set Tracking

    /// <summary>
    ///     Total hero kills in ranked matches.
    /// </summary>
    [PHPProperty("rnk_herokills")]
    ...
    /// </summary>
    [PHPProperty("rnk_wards")]
    public string Wards { get; init; } = statistics.WardsPlaced.ToString();

    /// <summary>
    ///     Total easy mode ranked matches played.
    /// </summary>
    [PHPProperty("rnk_em_played")]
    public string EasyModeGamesPlayed { get; init; } = "0"; // TODO: Implement Data Tracking

    /// <summary>
    ///     The account level for ranked mode.
    /// </summary>
    [PHPProperty("rnk_level")]
    public string RankedLevel { get; init; } = account.User.TotalLevel.ToString();

    /// <summary>
    ///     The current experience points towards the next ranked level.
    /// </summary>
    [PHPProperty("rnk_level_exp")]
    public string RankedLevelExperience { get; init; } = account.User.TotalExperience.ToString();

    /// <summary>
    ///     The minimum experience earned in a single ranked match.
    /// </summary>
    [PHPProperty("rnk_min_exp")]
    public string RankedMinimumExperience { get; init; } = "0"; // TODO: Implement Data Tracking

    /// <summary>
    ///     The maximum experience earned in a single ranked match.
    /// </summary>
    [PHPProperty("rnk_max_exp")]
    public string RankedMaximumExperience { get; init; } = "0"; // TODO: Implement Data Tracking
    ...
    public string CampaignWins { get; init; } = "0"; // TODO: Implement Data Tracking

    /// <summary>
    ///     Total campaign mode losses.
    /// </summary>
    [PHPProperty("cam_losses")]
    public string CampaignLosses { get; init; } = "0"; // TODO: Implement Data Tracking
    ...
    public string CasualSeasonWins { get; init; } = "0"; // TODO: Implement Data Tracking

    /// <summary>
    ///     Total casual campaign mode losses.
    /// </summary>
    [PHPProperty("cam_cs_losses")]
    public string CasualSeasonLosses { get; init; } = "0"; // TODO: Implement Data Tracking
