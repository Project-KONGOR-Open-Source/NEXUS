...
{
    internal SRPAuthenticationSessionData()
    {
    ...
    /// </summary>
    internal required string ClientPublicEphemeral { get; init; }

    /// <summary>
    ///     B : the public ephemeral key generated by the server
    /// </summary>
    internal string ServerPublicEphemeral { get; init; }

    /// <summary>
    ///     b : the secret ephemeral key generated by the server
    /// </summary>
    internal string ServerPrivateEphemeral { get; init; }
    ...
    /// </summary>
    internal required string LoginIdentifier { get; init; }
    ...
    /// </summary>
    internal required string SystemInformation { get; init; }

    /// <summary>
    ///     Returns the verifier derived from the client's private key.
    /// </summary>
    internal string Verifier { get; init; }
}
